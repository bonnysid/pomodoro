...
- Показ окна поверх остальных по завершении любого этапа, включая выход из трея. По умолчанию включён; отключается в настройках поведения. Постоянное закрепление окна остаётся отдельной настройкой.
